...
*
* \file            Lesson18.c
* \author          Jeff Molofee ( NeHe ) & TipTup originely, Modified for LCCWin32 compiler by Robert Wishlaw 2002/11/23
* \author          After adapted by Thierry Dechaize to verify paradigm : one source for multiple C Compilers
* \version         1.0.1.2
* \date            29 décembre 2015
* \brief           Ouvre une simple fenêtre Windows et dessine des textes générés en 2D Font, ainsi qu'une forme en rotation en forme de losange avec OpenGL.
...
int LoadGLTextures()									// Load Bitmaps And Convert To Textures
{
	...
	if (!NeHeLoadBitmap3("../../Data/Wall2.bmp", texture))		// Load The Bitmap
		return FALSE;
